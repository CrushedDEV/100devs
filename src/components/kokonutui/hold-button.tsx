...
interface HoldButtonProps
  ...
  holdDuration?: number;
  /** Fired once the bar has been filled without releasing. */
  onHoldComplete?: () => void;
  label?: string;
  holdingLabel?: string;
}
...
export default function HoldButton({
  ...
  async function handleHoldStart() {
    ...
    // `start` resolves only if the animation runs to completion; releasing the
    // pointer calls `controls.stop()`, which rejects/interrupts it.
